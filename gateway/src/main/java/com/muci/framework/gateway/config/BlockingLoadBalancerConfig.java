package com.muci.framework.gateway.config;
 ...
 */
public class BlockingLoadBalancerConfig extends BlockingLoadBalancerClient {
    private final ReactiveLoadBalancer.Factory<ServiceInstance> loadBalancerClientFactory;

    public BlockingLoadBalancerConfig(LoadBalancerClientFactory loadBalancerClientFactory,
